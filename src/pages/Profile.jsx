...
function Profile() {
  return (
    <div className="w-full px-7 flex flex-col justify-center items-start md:border md:border-gray-200 md:rounded-xl md:w-3/5 md:ml-72 md:shadow-lg md:p-10 md:mt-10">
      ...
      <div className="flex justify-between w-full items-end mt-20 md:-mt-12 md:px-20">
        <img
        ...
        <button
          type="button"
          class="text-white bg-gray-800 font-medium rounded-full text-sm px-5 py-2.5 m-0"
        >
          Edit Profile
        </button>
      </div>
      <h5 className="mt-3 text-lg font-medium md:px-20">John Doe</h5>
      <p className="text-gray-500 text-md md:px-20">@johndoe</p>
      <p className="mt-3 text-md md:px-20">What's happening?!</p>
      <div className="flex gap-4 mt-3 md:px-20">
